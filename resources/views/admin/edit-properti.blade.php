        ...
        <form method="POST" action="{{ route('admin.properti.update', $room->id) }}"
          ...
          <div class="mb-4">
            ...
            <select
              ...
              <option value="Putra" {{ $room->gender_type == 'Putra' ? 'selected' : '' }}>Putra</option>
              <option value="Putri" {{ $room->gender_type == 'Putri' ? 'selected' : '' }}>Putri</option>
            </select>
          </div>

          <div class="mb-4">
            <label class="block text-gray-700 font-semibold mb-2">Harga</label>
            <input type="number" value="{{ $room->price }}" placeholder="Contoh : 350000"
              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              name="price" required>
          </div>
          ...
          <div class="mb-4">
            ...
            <input type="text" value="{{ $room->facilities }}" placeholder=" Contoh : Bed, Lemari, Meja Belajar"
              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          <div class="mb-4">
            ...
            <input type="text" value="{{ $room->area_size }}" placeholder=" Contoh : 4x6"
              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          <div class="mb-4">
            ...
            <select
              ...
              <option disabled>-- Pilih --</option>
              <option value="0" {{ $room->is_electric_included == 0 ? 'selected' : '' }}>Token</option>
              <option value="1" {{ $room->is_electric_included == 1 ? 'selected' : '' }}>Include</option>
            </select>
          </div>
          ...
          <div class="mb-4">
            ...
            <select
              ...
              <option disabled>-- Pilih --</option>
              <option value="0" {{ $room->is_water_included == 0 ? 'selected' : '' }}>Tidak Ada</option>
              <option value="1" {{ $room->is_water_included == 1 ? 'selected' : '' }}>Include</option>
            </select>
          </div>
          ...
          <div class="mb-4">
            ...
            <textarea class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              name="room_rules" rows="4">{{ $room->room_rules }}</textarea>
          </div>
