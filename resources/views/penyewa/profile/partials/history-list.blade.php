...
@elseif(isset($filtered) && $filtered)
    {{-- Filtered empty state: there ARE bookings but none match the current filters --}}
    <div class="flex flex-col items-center justify-center py-16 text-center">
        ...
        <p class="text-sm font-semibold text-slate-400">Tidak ada hasil yang cocok</p>
        <p class="text-xs text-slate-300 mt-1">Coba ubah kata kunci pencarian atau filter yang digunakan</p>
    </div>
@else
    {{-- True empty state: user has no bookings at all --}}
    <div class="flex flex-col items-center justify-center py-16 text-center">
        <div class="w-14 h-14 bg-slate-100 rounded-2xl flex items-center justify-center text-slate-300 mb-4">
