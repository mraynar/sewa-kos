    ...
    <div class="flex justify-between h-16 items-center">
      ...
      <div class="flex-shrink-0">
        <a href="/" class="flex items-center gap-2.5">
          <span class="w-7 h-7 bg-primary rounded-lg flex items-center justify-center shadow-md shadow-primary/30">
        ...
        @auth
          <div class="hidden md:flex items-center gap-1 text-right">
            <div class="pr-3 border-r border-slate-100">
              <p class="text-[10px] font-semibold uppercase text-slate-400 tracking-widest leading-none mb-0.5">
                Mahasiswa</p>
